...
<section id="api-clipboard-section">
    <article>
        ...
        <a class="btn btn-link-red dot-key" target="_blank"
...
ㅎㅇㅇㅇ
    ...
    <article>
        ...
        <div class="api-clipboard">
            <h4 class="dot-key">URL: https://myblog.xasquatch.net/api/members/<i class="dot-key">{member-Number}</i>/boards</h4>
            <h4 class="dot-key">URL Explain</h4>
            <p><i class="dot-key">{member-Number}</i> : My Information의 ID값(Long형 숫자타입)</p>
            <p>Method : GET</p>
