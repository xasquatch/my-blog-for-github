    ...
    <form class="form-horizontal" action="${path}/user/${sessionMember.no}/check-email" method="POST">
        <div id="check-pwd-explain" class="dot-key" style="font-size: 3rem;">
            <script>
                window.onload =function (){
                    textScript.insertText('#check-pwd-explain', '[Change Email]<BR>변경할 이메일을<BR>입력해주세요<hr>', 1);
                }
            </script>
        </div>
        <div style="text-align: center;">
            <div class="input-group form-group-lg">
                ...
                <input type="email" class="form-control" name="email" placeholder="${sessionMember.email}">
            </div>
            <hr>
